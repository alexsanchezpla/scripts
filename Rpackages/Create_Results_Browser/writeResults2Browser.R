...
myGENCategs <- c("Reports and result summaries",
                 ...
                 "Power Analysis")
myGENNames <- c("INFO", "DATA", "QC", "NORM", "ANALYSIS",
                "ANNOT", "MULTCOMP", "CLUSTER", "GO", "KEGG", "IPA", "POWER")

### FA (for 'Functional Analysis')
### Use this categories to prepare a results browser for a functional analysis performed on the results of an omics analysis

myFACategs <- c("Reports and result summaries",
...
myFANames <- c("INFO", "INPUT", "GAGE", "DAVID", "GOPROF", "GOEA", "KEGGEA", "IPA")
